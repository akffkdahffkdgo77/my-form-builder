    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 top-0 z-50 min-h-screen bg-[#f6f6f6]">
            <div className="flex h-full flex-col items-center justify-center">
                ...
                <button type="button" onClick={() => reset()} className="group flex items-center gap-2.5 rounded border border-slate-900 bg-slate-900 p-2.5 text-slate-50 hover:opacity-70">
